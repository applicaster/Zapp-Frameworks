...
/// The URL for the certificate server. By default, this will equal the certificate URL configured in the <code>KeySystemConfiguration</code>
...
@protocol CertificateRequestCallback
...
SWIFT_CLASS("_TtC13THEOplayerSDK19GoogleImaController")
@interface GoogleImaController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
