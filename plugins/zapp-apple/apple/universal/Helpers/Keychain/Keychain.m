...
+ (NSString *)keyFromNameSpace:(NSString *)key andNameSpace:(NSString *)nameSpace {
    NSString *newKey = key;
    if (nameSpace != nil) {
        newKey = [NSString stringWithFormat:@"%@ - %@", nameSpace, key];
    }
    return newKey;
}

+ (BOOL)setString:(NSString *)string forKey:(NSString *)key andNameSpace:(NSString *)nameSpace {
    NSString *newKey = [self keyFromNameSpace:key andNameSpace:nameSpace];
    return [self setString:string forKey:newKey];
}
...
+ (BOOL)deleteStringForKey:(NSString *)key andNameSpace:(NSString *)nameSpace {
    NSString *newKey = [self keyFromNameSpace:key andNameSpace:nameSpace];
    return [self deleteStringForKey:newKey];
}
...
+ (NSString *)getStringForKey:(NSString *)key andNameSpace:(NSString *)nameSpace {
    NSString *newKey = [self keyFromNameSpace:key andNameSpace:nameSpace];
    return [self getStringForKey:newKey];
}
