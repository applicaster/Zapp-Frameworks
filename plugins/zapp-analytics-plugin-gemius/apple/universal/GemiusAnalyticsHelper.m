...
#import "GemiusAnalyticsHelper.h"
...
@interface GemiusAnalyticsHelper ()

@property (nonatomic, weak) id<GemiusAnalyticsDelegate> delegate;
...
@implementation GemiusAnalyticsHelper

- (instancetype)initWithProviderProperties:(NSDictionary *)providerProperties
                                  delegate:(id<GemiusAnalyticsDelegate>)delegate {
    self = [super init];
    if (self) {
